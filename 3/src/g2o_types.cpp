...
namespace myslam
{
    ...
    {
        const g2o::VertexSBAPointXYZ* point = static_cast<const g2o::VertexSBAointXYZ*>(_vertices[0]);
        const g2o::VertexSE3Expmap* pose =static_cat<const g2o::VertexSE3Expmap*> (_vertices[1]);
    ...
    void EdgeProjectXYZRGBD::linearizeOplus()
    {
        ...
        _jacbianOplusXi = -T.rotation().toRotationMatrix();
    ...
    void EigenProjectXYZRGBDPoseOnly::computeError()
    {
        const g2o::VertexSE3Expmap* pose = static_cast<const g2o::VertexSE3Expmap*> (_vertices[0]);
        _error = _measurement - pose->estimate().map(point_);
    }

    void EigenProjectXYZRGBDPoseOnly::linearizeOplus()
    {
    ...
    {
        // const g2o::VertexSBAPointXYZ* point = static_cast<const g2o::VertexSBAointXYZ*>(_vertices[0]);
        const g2o::VertexSE3Expmap* pose =static_cat<const g2o::VertexSE3Expmap*> (_vertices[0]);
